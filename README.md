...
| Дата | Изменение |
|------|-----------|
| 2026-06-11 | Главная: компактная таблица сводки (`_IntegrationDashboardTable`), параллельная загрузка статистики, ссылки на разделы и фильтр ошибок; onboarding в collapse |
